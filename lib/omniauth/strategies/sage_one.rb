...
module OmniAuth
  module Strategies
    class SageOne < OmniAuth::Strategies::OAuth2
      ...
      # SageOne has different token endpoints for each available country. The country is returned in the authorization
      # callback. Configure the OAuth client to use that information.
      def client
